public class Other {
	...
	//returns "MidnightMidnight2Midnight22Midnight222Midnight2222..."
    ...
    public String threatLevel(int val) {
		...
		String conv = levelifier(val, toReturn).substring(0, Math.abs(val));	//takes first 'val' characters of whatever levelifier returns
		return conv;
    }
